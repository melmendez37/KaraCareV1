    ...
    return(
        <View style = {styles.container}>
            <LinearGradient colors = {['#00598B', '#8FBC8F']} style = {styles.something}>
                    ...
                    <Text style={styles.text}>SEND MEDICAL RESULTS</Text>
                    <View style={styles.recOne}/>
                    
                    <Text style={styles.confirm}>Medical results sent.</Text>
            </LinearGradient>
        </View>
    )
};
...
const styles = StyleSheet.create({
    ...
    image: {width: 65, height: 66, left: 76, top: 153, position: 'absolute'},
    title: {width: 200, height: 49, left: 150, top: 162, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 18, fontFamily: 'Roboto', fontWeight: '700'},
    ...
    buttonText: {width: 90, height: 40, top:10, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 14, fontFamily: 'Roboto', fontWeight: '700'},
    text: {width: 350, height: 77, left: 75, top: 260, position: 'absolute', color: 'white', fontSize: 24, fontFamily: 'Roboto', fontWeight: '700'},
    header: {width: 350, height: 77, left: 40, top: 240, position: 'absolute', backgroundColor: '#46525E'},
    confirm: {width: 200, height: 120, left: 115, top: 425, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'Roboto', fontWeight: '700'},
});

export default SentResNotif;