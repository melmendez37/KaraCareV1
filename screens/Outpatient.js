...
const styles = StyleSheet.create({
    ...
    title:{width: 248, height: 49, left: 140, top: 145, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 16, fontFamily: 'Roboto', fontWeight: '700'},
    image:{width: 68, height: 66, left: 80, top: 130, position: 'absolute'},
    button2:{width: 80, height: 40, left: 222, top: 490, position: 'absolute', backgroundColor: '#46525E', borderRadius: 100},
    button1:{width: 80, height: 40, left: 133, top: 490, position: 'absolute', backgroundColor: '#D9D9D9', borderRadius: 100},
    recTwo:{width: 350, height: 80, left: 40, top: 685, position: 'absolute', backgroundColor: '#8C8C8C'},
    buttonText2:{width: 80, height: 40, top: 10, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 14, fontFamily: 'Roboto', fontWeight: '700'},
    buttonText1:{width: 80, height: 40, top: 10, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 14, fontFamily: 'Roboto', fontWeight: '700'},
    recThree:{width: 350, height: 100, left: 40, top: 765, position: 'absolute', backgroundColor: '#46525E'},
    recFour:{width: 350, height: 41, left: 40, top: 65, position: 'absolute', backgroundColor: '#46525E'},
    header:{width: 350, height: 48, left: 40, top: 224, position: 'absolute', backgroundColor: '#46525E'},
    recText1:{width: 237, height: 23, left: 100, top: 234, position: 'absolute', textAlign: 'center', color: '#FFFBFB', fontSize: 20, fontFamily: 'Roboto', fontWeight: '700'},
