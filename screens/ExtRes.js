...
const styles = StyleSheet.create({
    ...
    buttonOne: {width: 70, height: 30, left: 133, top: 560, position: 'absolute', backgroundColor: '#D9D9D9', borderRadius: 50},
    buttonTwo: {width: 70, height: 30, left: 229, top: 560, position: 'absolute', backgroundColor: '#46525E', borderRadius: 50},
    ...
    confirm: {width: 40, height: 15, left: 147, top: 567, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 10, fontFamily: 'Roboto', fontWeight: '700'},
    delete: {width: 40, height: 15, left: 242, top: 567, position: 'absolute', textAlign: 'center', color: '#D9D9D9', fontSize: 10, fontFamily: 'Roboto', fontWeight: '700'},
